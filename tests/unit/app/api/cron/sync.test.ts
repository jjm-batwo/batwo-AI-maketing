...
describe('GET /api/cron/sync', () => {
  ...
  it('should_sync_campaigns_and_insights_for_each_user', async () => {
    mockFindMany.mockResolvedValue([
      { id: 'acc1', userId: 'user1', metaAccountId: 'act_111', accessToken: 'token1', tokenExpiry: null, businessName: null, currency: 'KRW', timezone: 'Asia/Seoul', createdAt: new Date(), updatedAt: new Date() },
      { id: 'acc2', userId: 'user2', metaAccountId: 'act_222', accessToken: 'token2', tokenExpiry: null, businessName: null, currency: 'KRW', timezone: 'Asia/Seoul', createdAt: new Date(), updatedAt: new Date() },
    ] as never)

    mockSyncCampaigns.execute.mockResolvedValue({
      created: 1, updated: 2, archived: 0, total: 3,
    })
  ...
  it('should_skip_expired_tokens_and_continue', async () => {
    ...
    mockFindMany.mockResolvedValue([
      { id: 'acc1', userId: 'user1', metaAccountId: 'act_111', accessToken: 'token1', tokenExpiry: pastDate, businessName: null, currency: 'KRW', timezone: 'Asia/Seoul', createdAt: new Date(), updatedAt: new Date() },
      { id: 'acc2', userId: 'user2', metaAccountId: 'act_222', accessToken: 'token2', tokenExpiry: null, businessName: null, currency: 'KRW', timezone: 'Asia/Seoul', createdAt: new Date(), updatedAt: new Date() },
    ] as never)
