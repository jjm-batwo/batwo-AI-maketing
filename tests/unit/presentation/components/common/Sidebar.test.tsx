...
describe('Sidebar', () => {
  ...
  describe('active state', () => {
    ...
    it('should highlight active campaigns link', () => {
      ...
      const campaignsLink = screen.getByText('캠페인').closest('a')
      expect(campaignsLink).toHaveClass('bg-accent', 'text-accent-foreground')
    ...
    it('should highlight active reports link', () => {
      ...
      const reportsLink = screen.getByText('보고서').closest('a')
      expect(reportsLink).toHaveClass('bg-accent', 'text-accent-foreground')
    ...
    it('should not highlight inactive links', () => {
      ...
      const campaignsLink = screen.getByText('캠페인').closest('a')
      expect(campaignsLink).not.toHaveClass('bg-accent')
  ...
  describe('icons', () => {
    it('should render navigation icons', () => {
      ...
      expect(navIcons.length).toBe(5) // 5 main nav items (portfolio removed)
    })
  ...
  describe('styling and layout', () => {
    ...
    it('should have backdrop blur effect', () => {
      ...
      const sidebar = screen.getByRole('complementary')
      expect(sidebar).toHaveClass('bg-background', 'shadow-sm')
    })
  ...
  describe('navigation section', () => {
    ...
    it('should have hover effects on nav items', () => {
      ...
      const dashboardLink = screen.getByText('대시보드').closest('a')
      expect(dashboardLink).toHaveClass('hover:text-foreground', 'hover:bg-accent/50')
    })
