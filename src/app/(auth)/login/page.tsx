  ...
  return (
    <Card className="shadow-lg">
      <CardHeader className="text-center">
        ...
        <CardDescription>바투 AI 마케팅 솔루션에 오신 것을 환영합니다</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            ...
            />
            {errors.email && (
              <p className="text-sm text-red-500">{errors.email.message || '이메일을 입력해주세요'}</p>
            )}
          </div>
        ...
        <div className="space-y-3">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full bg-[#FEE500] text-[#3C1E1E] hover:bg-[#FEE500]/90"
