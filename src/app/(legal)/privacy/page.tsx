...
export default function PrivacyPage() {
  ...
  return (
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <p>
        바투(이하 &quot;회사&quot;)는 이용자의 개인정보를 중요시하며, &quot;정보통신망 이용촉진 및
        정보보호&quot; 에 관한 법률, 개인정보보호법을 준수하고 있습니다.
      </p>
      ...
      <section>
        ...
        <ul>
          ...
          <li>서비스 제공: AI 마케팅 분석, 광고 캠페인 관리, 보고서 생성 등</li>
          <li>서비스 개선: 신규 서비스 개발, 서비스 품질 향상, 고객 문의 응대</li>
      ...
      <section>
        ...
        <p>
          위 서비스들은 각자의 개인정보처리방침에 따라 데이터를 처리하며, 회사는 서비스 제공에
          필요한 최소한의 정보만 전달합니다.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>법령에 의한 보관: 관계 법령에 따라 필요한 경우 해당 기간 동안 보관</li>
        </ul>
      </section>

      <section>
        <h2>5. 이용자의 권리</h2>
        <p>이용자는 언제든지 본인의 개인정보에 대해 다음의 권리를 행사할 수 있습니다:</p>
        <ul>
          <li>개인정보 열람 요청</li>
          <li>개인정보 정정 요청</li>
          <li>개인정보 삭제 요청</li>
        ...
        <p>
          권리 행사는 서비스 내 설정 메뉴를 통해 직접 하거나, 고객센터에 문의하여 처리할 수
          있습니다.
        </p>
      </section>
      ...
      <section>
        <h2>7. 쿠키의 사용</h2>
        <p>
          회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 쿠키(cookie)를 사용합니다. 쿠키는
          웹사이트를 운영하는데 이용되는 서버가 이용자의 브라우저에게 보내는 아주 작은 텍스트 파일로
          이용자의 컴퓨터에 저장됩니다.
        </p>
        <p>
          이용자는 쿠키 설치에 대한 선택권을 가지고 있으며, 웹브라우저에서 옵션을 설정함으로써 모든
      ...
      <section>
        ...
        <p>
          이 개인정보처리방침은 법령, 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이
          있을 시에는 변경사항의 시행 7일 전부터 서비스 내 공지사항을 통해 고지할 것입니다.
        </p>
      </section>
