    ...
    <>
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              ...
                              onClick={() =>
                                setConfirmDialog({ open: true, admin, action: 'remove' })
                              }
                            >
      ...
      >
        <DialogContent>
          ...
          <div className="py-4">
            <p className="text-sm">
              작업: <span className="font-medium">관리자 권한 제거</span>
            </p>
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleAdminAction} disabled={processing}>
              {processing ? '처리 중...' : '확인'}
            </Button>
          </DialogFooter>
        </DialogContent>
