    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-background to-muted/20 px-4">
      <div className="container flex max-w-md flex-col items-center text-center">
        ...
        <div className="relative mb-8">
          <div
            className="text-[150px] font-bold leading-none text-muted-foreground/10 sm:text-[200px]"
            aria-hidden="true"
          >
            404
          </div>
          <Search
            className="absolute left-1/2 top-1/2 h-16 w-16 -translate-x-1/2 -translate-y-1/2 text-muted-foreground/50"
            aria-hidden="true"
          />
        </div>
