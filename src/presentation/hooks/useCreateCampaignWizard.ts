...
import type {
  WizardSubmitStage,
  ExtendedCampaignFormData,
} from '@/presentation/components/campaign/CampaignCreateForm/types'
...
async function createAdvantageCampaign(
  data: Record<string, unknown>
): Promise<AdvantageCampaignResponse> {
...
export function useCreateCampaignWizard() {
  ...
  // Advantage+ 모드 제출
  const submitAdvantage = useCallback(
    async (data: ExtendedCampaignFormData) => {
      setError(null)
      try {
