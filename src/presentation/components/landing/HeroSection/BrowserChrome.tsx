    ...
    <div className="flex items-center gap-2 px-4 py-3 border-b bg-muted/30">
      <div className="flex gap-1.5" role="presentation" aria-label="브라우저 제어 버튼">
        <div className="relative group/dot">
          <div
            className="absolute inset-0 w-3.5 h-3.5 rounded-full bg-red-400 blur-sm opacity-0 group-hover/dot:opacity-50 transition-opacity"
            aria-hidden="true"
          />
        ...
        <div className="relative group/dot">
          <div
            className="absolute inset-0 w-3.5 h-3.5 rounded-full bg-amber-400 blur-sm opacity-0 group-hover/dot:opacity-50 transition-opacity"
            aria-hidden="true"
          />
        ...
        <div className="relative group/dot">
          <div
            className="absolute inset-0 w-3.5 h-3.5 rounded-full bg-emerald-400 blur-sm opacity-0 group-hover/dot:opacity-50 transition-opacity"
            aria-hidden="true"
          />
