  ...
  return (
    ...
    >
      <div className="flex items-start gap-2.5">
        <div
          className="p-1 bg-green-100 dark:bg-green-900/50 rounded-full mt-0.5 shrink-0"
          aria-hidden="true"
        >
          <Sparkles className="h-3.5 w-3.5 text-green-600 dark:text-green-400" />
        </div>
        <div>
          <p className="text-xs font-medium text-green-800 dark:text-green-300 mb-0.5">{title}</p>
