      ...
      <div className="flex items-center justify-between space-y-0 pb-2 relative z-10">
        ...
        {Icon && (
          <div
            ...
            className={cn(
              'p-2 rounded-lg bg-white/50 dark:bg-white/10 text-primary shadow-sm ring-1 ring-black/5 dark:ring-white/10 transition-transform duration-300 group-hover:rotate-12'
            )}
          >
